...
Ваш стейк лишається на місці. Цього тижня репетиція йде на публічному testnet,
 тож SOL, який ви вже делегували на mainnet-beta, і далі працює під TowerBFT і
 нікуди не переїжджає. Дивитися варто на оператора: валідатор, який каже, який
 клієнт крутить і як готується до Alpenglow, читається спокійніше за того, хто
 замовкає, коли клієнт змінюється.
