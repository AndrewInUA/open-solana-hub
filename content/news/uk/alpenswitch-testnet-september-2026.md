...
Ця зміна консенсусу не дає вам окремого завдання. Стейк, який ви вже делегували,
 лишається в того самого валідатора і під час репетиції на testnet, і коли
 mainnet перейде пізніше. Його не переносять через те, що змінився протокол
 голосування.

Причини перенести стейк звичайні: валідатор підняв комісію або його робота
 погіршилась. Alpenglow нових правил до цього не додає.
