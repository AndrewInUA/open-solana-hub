...
/**
 * The Hub front-end has no backend of its own yet – all live data comes from
 * the production Validator Transparency Dashboard deployment (APIs + cron).
 */
const API_BASE = "https://validator-transparency-dashboard.vercel.app";
