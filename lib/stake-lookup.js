 ...
 *   3. Reward history: getInflationReward for a consecutive window of up to
 *      16 finished epochs (from activation when that span fits). Missing
 *      epochs are not filled with 0.
