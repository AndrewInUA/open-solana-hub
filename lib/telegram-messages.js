...
function helpMessage() {
  return [
    ...
    "<b>Turn notes on</b> / <b>Turn notes off</b> – tap to start or stop epoch notes. A higher validator cut gets its own note. Notes default on after you link a wallet",
...
function notifyToggled(on) {
  return on
    ? "Epoch notes are on. You will get a short checkup when a new Solana epoch starts, and a separate note if your validator raises its cut. /status still works anytime."
