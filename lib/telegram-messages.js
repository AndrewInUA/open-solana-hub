...
function helpMessage() {
  return [
    ...
    "<b>Turn notes on</b> / <b>Turn notes off</b> – tap to start or stop epoch notes. A higher validator cut gets its own note. A lower cut is on Your validator – no extra ping. Notes default on after you link a wallet",
...
function commissionRaiseMessage(raises) {
  ...
  lines.push("");
  lines.push("A higher cut does not undo itself. Open Your validator for the history.");
  lines.push("");
  for (const r of list) {
