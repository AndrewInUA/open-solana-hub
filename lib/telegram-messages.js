...
const { moneyLines, mystakeUrl, compareUrl, storyContextFromView, FIAT_CODES, HOW_TO_READ, TONE_COPY, toneBadge, fiatFreshnessCopy, worseTone, feeHistoriesFromRows } = core;
...
function notifyToggled(on) {
  return on
    ? "Epoch notes are on. You will get a short checkup when a new Solana epoch starts, and a separate note if your validator raises its cut. A lower cut is not a ping. /status still works anytime."
