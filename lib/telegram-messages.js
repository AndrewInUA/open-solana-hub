...
function validatorMessage({ wallet, vote, votes, feeHistories } = {}) {
  ...
  if (histories.length) {
    const lines = [
      "Today’s cut and recorded moves. A raise shrinks what you keep. Telegram pings a raise. A lower cut stays on Stake health – no extra ping.",
      ""
    ];
