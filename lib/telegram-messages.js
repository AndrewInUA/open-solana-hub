...
function startMessage() {
  return [
    ...
    "/status – how much is staked, last-epoch payout, consecutive payouts we could follow, OK / Watch / Risk",
    ...
    "",
    `<a href="${esc(mystakeUrl(null, null, { story: true }))}">Stake story</a> – last epoch payout, plus consecutive payouts we could follow on Stake health.`,
...
function helpMessage() {
  return [
    ...
    "",
    "<b>Status</b> – how much is staked, last-epoch payout, consecutive payouts we could follow, OK / Watch / Risk",
    "<b>Stake story</b> – last epoch payout, plus consecutive payouts we could follow on Stake health",
...
function fullStoryMessage({ wallet, stake, vote } = {}) {
  ...
  const parts = [
    "Last epoch payout, plus consecutive payouts we could follow. Not lifetime history.",
    "",
...
function telegramNext(overall, pack) {
  ...
  if (overall.tone === "risk") {
    return "Open Stake story for last epoch and consecutive payouts we could follow.";
  }
  return overall.next || "";
}
