...
const { shortKey, moneyLine, mystakeUrl, FIAT_CODES, fmtPct, HOW_TO_READ, summarizeRecentPicture, fiatFreshnessCopy } = core;
...
function startMessage() {
  return [
    ...
    "/status – checkup now (OK / Watch / Risk)",
...
function helpMessage() {
  return [
    ...
    "",
    "<b>Status</b> – checkup now (OK / Watch / Risk)",
