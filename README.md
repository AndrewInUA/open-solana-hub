...
| `/compare/mystake.html` | **Stake health** – paste a wallet (or stake account) to see stake size, last-epoch and recent rewards (≈ fiat), then a short OK / Watch / Risk validator overlay |
